            ...
            {userType === 'client' && (
              <div className="mt-4 p-3 bg-info/10 rounded-lg">
                <p className="text-sm text-info flex items-start gap-2">
                  <Icon icon="solar:info-circle-bold" className="text-lg mt-0.5" />
                  <span>
                    As a client, you can post jobs and hire freelancers. If you want to offer services, 
                    you'll need to create a separate freelancer account.
                  </span>
                </p>
              </div>
            )}
            ...
            {userType === 'both' && (
              <div className="mt-4 p-3 bg-success/10 rounded-lg">
                <p className="text-sm text-success flex items-start gap-2">
                  <Icon icon="solar:shield-check-bold" className="text-lg mt-0.5" />
                  <span>
                    You have full access to both client and freelancer features. You can switch between
                    modes from your dashboard.
                  </span>
                </p>
              </div>
            )}
